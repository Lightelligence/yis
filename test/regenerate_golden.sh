...
cp $PROJ_DIR/bazel-bin/digital/rtl/scripts/yis/test/golden_inputs/*_mem.svh $PROJ_DIR/digital/rtl/scripts/yis/test/golden_outputs/
...
chmod +w $PROJ_DIR/digital/rtl/scripts/yis/test/golden_outputs/*.sv*
